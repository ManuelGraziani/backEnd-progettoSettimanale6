...
<x-app-layout>
    ...
    <div class="flex justify-between items-center">
            ...
            <a href="{{ route('courses.create') }}" class="btn btn-outline-secondary">Aggiungi orsi</a>
            @endif
        </div>
    </x-slot>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100 ">
                    <form method="POST" action="/courses/{{ $course->id }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleInputPassword1" name="description" value="{{ $course->description }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="end_date" id="end_date" value="{{ $course->end_date }}">
                        </div>
